...
import { getFollowUp } from "../../../services/SettingsService";
							...
							{mediaBlog.map((item, ind) => (
								...
								>
									...
									<div className="media-body">
										...
										<small
											className={`mb-0 text-${
												item.status === "Available" ? "primary" : "danger"
											}`}
										>
											{item.status}
										</small>
				...
				<Col lg={"4"} md={"12"}>
					<div className="card">
						...
						<div className="chart-wrapper">
							<Sparklines
								data={[
									6, 5, 8, 4, 8, 6, 4, 4, 6, 5, 9, 5, 8, 3, 4, 8, 9, 8, 5, 7,
								]}
							>
								<SparklinesLine
									style={{ fill: "#a2bad3", fillOpacity: ".3" }}
								/>
							</Sparklines>
						</div>
					</div>
					...
					<div className="card">
						...
						<div className="chart-wrapper">
							...
							>
								<SparklinesLine
									color="#ff9e4e"
									style={{ fill: "#ff9e4e", fillOpacity: ".3" }}
								/>
							</Sparklines>
						</div>
					</div>
